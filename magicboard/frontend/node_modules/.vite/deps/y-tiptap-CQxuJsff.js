import { Cn as PluginKey, En as TextSelection, Mn as Slice, On as ReplaceStep, Sn as Plugin, bn as AllSelection, jn as Fragment, vn as Decoration, wn as Selection, xn as NodeSelection, yn as DecorationSet } from "./dist-BP9Ug2YZ.js";
import { $ as createRelativePositionFromTypeIndex, $t as toBase64, C as UndoManager, Cn as min, Dn as setIfUndefined, Dt as isDeleted, En as create$1, F as YXmlElement, J as createDeleteSet, N as YText, Ot as isParentOf, Q as createRelativePositionFromJSON, Qt as encodeAny, Sn as max, Tn as create, Ut as snapshot, V as applyUpdateV2, W as compareRelativePositions, Xt as timeout, Z as createID, Zt as doc, _ as Item, an as oneOf, bn as BIT30, bt as findIndexSS, en as isBrowser, et as createSnapshot, f as ContentString, fn as methodUnimplemented, kt as iterateDeletedStructs, m as Doc, nn as every, p as ContentType, pn as unexpectedCase, q as createAbsolutePositionFromRelativePosition, qt as typeListToArraySnapshot, rn as keys, u as ContentFormat, x as Snapshot, xt as findRootTypeKey, y as RelativePosition, z as YXmlText } from "./yjs-C9zmt_g_.js";
import "./awareness-D2eSQWzp.js";
		...
		*/
		...
		return {
			update: (editorView, prevState) => {
				updateCursorInfo(editorView, { force: !!(ySyncPluginKey.getState(editorView.state)?.isChangeOrigin && prevState?.doc && !prevState.doc.eq(editorView.state.doc)) });
			},
			destroy: () => {
...
//# sourceMappingURL=y-tiptap-CQxuJsff.js.map