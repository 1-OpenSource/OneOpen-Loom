import { B as applyUpdate, Pt as mergeUpdates, _n as writeVarString, cn as readVarInt, dn as readVarUint8Array, gn as toUint8Array, hn as length, ht as encodeStateVector, in as getUnixTime, ln as readVarString, m as Doc, mn as createEncoder, on as createDecoder, pt as encodeStateAsUpdate, sn as peekVarString, un as readVarUint, vn as writeVarUint, yn as writeVarUint8Array } from "./yjs-C9zmt_g_.js";
import { i as removeAwarenessStates, n as applyAwarenessUpdate, r as encodeAwarenessUpdate, t as Awareness } from "./awareness-D2eSQWzp.js";
//#region node_modules/@hocuspocus/common/dist/hocuspocus-common.esm.js
var AuthMessageType = /* @__PURE__ */ function(AuthMessageType) {
...
*/
var WsReadyStates = /* @__PURE__ */ function(WsReadyStates) {
...
var WebSocketStatus = /* @__PURE__ */ function(WebSocketStatus) {
...
var MessageReceiver = class {
	...
	applySyncMessage(provider, emitSynced) {
		...
		if (emitSynced && syncMessageType === 1) provider.synced = true;
	}
